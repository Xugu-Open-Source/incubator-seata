 ...
 *
 */
public class XuguUpdateRecognizer extends BaseXuguRecognizer implements SQLUpdateRecognizer, JoinRecognizer {

    private final XuGuUpdateStatement ast;
     ...
     * @param ast         the ast
     */
    public XuguUpdateRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
        this.ast = (XuGuUpdateStatement) ast;
    }
    ...
    private String visitTableName(SQLExprTableSource tableSource) {
        ...
        XuGuOutputVisitor visitor = new XuGuOutputVisitor(tableName) {
