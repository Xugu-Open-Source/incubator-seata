 ...
 *
 */
public class XuguInsertRecognizer extends BaseXuguRecognizer implements SQLInsertRecognizer {

    private final XuGuInsertStatement ast;
     ...
     * @param ast         the ast
     */
    public XuguInsertRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
        this.ast = (XuGuInsertStatement) ast;
    }
