 ...
 *
 */
public class XuguSelectForUpdateRecognizer extends BaseXuguRecognizer implements SQLSelectRecognizer {
     ...
     * @param ast         the ast
     */
    public XuguSelectForUpdateRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
