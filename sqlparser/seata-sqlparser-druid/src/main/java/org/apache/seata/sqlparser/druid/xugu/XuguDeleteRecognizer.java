...
/**
 * The type xugu delete recognizer.
 *
 */
public class XuguDeleteRecognizer extends BaseXuguRecognizer implements SQLDeleteRecognizer {

    private final XuGuDeleteStatement ast;

    /**
     * Instantiates a new xugu delete recognizer.
     *
     * @param originalSQL the original sql
     * @param ast         the ast
     */
    public XuguDeleteRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
        this.ast = (XuGuDeleteStatement) ast;
    }
    ...
    public String getTableName() {
        ...
        XuGuOutputVisitor visitor = new XuGuOutputVisitor(sb) {
