...
/**
 * The type xugudb insert executor.
 *
 */
@LoadLevel(name = JdbcConstants.XUGU, scope = Scope.PROTOTYPE)
public class XuguInsertExecutor extends BaseInsertExecutor implements Defaultable {
