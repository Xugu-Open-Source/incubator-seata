 ...
 */
package org.apache.seata.rm.datasource.exec.xugu;
...
/**
 * The type xugudb Select for update executor.
 *
 * @param <S> the type parameter
 */
public class XuguSelectForUpdateExecutor<T, S extends Statement> extends SelectForUpdateExecutor<T, S> {
    /**
     * Instantiates a new xugu Select for update executor.
     *
     * @param statementProxy    the statement proxy
     * @param statementCallback the statement callback
     * @param sqlRecognizer     the sql recognizer
     */
    public XuguSelectForUpdateExecutor(
