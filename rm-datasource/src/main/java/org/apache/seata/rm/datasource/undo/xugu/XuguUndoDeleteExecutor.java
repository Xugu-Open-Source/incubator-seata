 ...
 *
 */
public class XuguUndoDeleteExecutor extends AbstractUndoExecutor {
     ...
     */
    public XuguUndoDeleteExecutor(SQLUndoLog sqlUndoLog) {
        super(sqlUndoLog);
    }
    ...
    protected String buildUndoSQL() {
        ...
        fields.addAll(getOrderedPkList(beforeImage, row, JdbcConstants.XUGU));
