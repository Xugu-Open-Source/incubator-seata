 ...
 *
 */
public class XuguUndoUpdateExecutor extends AbstractUndoExecutor {
    ...
    protected String buildUndoSQL() {
        ...
        List<String> pkNameList = getOrderedPkList(beforeImage, row, JdbcConstants.XUGU).stream()
                .map(e -> e.getName())
     ...
     */
    public XuguUndoUpdateExecutor(SQLUndoLog sqlUndoLog) {
        super(sqlUndoLog);
    }
